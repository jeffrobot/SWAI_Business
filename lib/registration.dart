...
class _RegistrationPageState extends State<RegistrationPage>{
  ...
  CarouselSliderController? buttonCarouselController = new CarouselSliderController();
  ...
  void register() async {
    if(isverified){
      ...
      SnackBar snackBar = SnackBar(content: Text('이메일 인증을 진행해주세요.'));
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              width: MediaQuery.of(context).size.width*0.9,
                              child: Center(
                                child: Text('이메일 인증완료!', style: TextStyle(color: Colors.green),),
                              ),
                            ):Container(),
                            Container(
                              margin: EdgeInsets.only(bottom: 20),
                              ...
                              child: TextButton(
                                ...
                                onPressed: () {
                                  sendverification();
                                  SnackBar snackBar = SnackBar(content: Text('인증 이메일이 전송되었습니다'));
                                  ScaffoldMessenger.of(context).showSnackBar(snackBar);
                                  setState(() {
                                ...
                                child: Text('인증 이메일 전송', style: TextStyle(color: Color(0xff707070)),)
                              ),
                            ),
                            Container(
                              margin: EdgeInsets.only(bottom: 20),
                              ...
                              child: TextButton(
                                ...
                                child: Text('이어서', style: TextStyle(color: Color(0xff707070)),)
                              ),
                            ),
                          ],
                        ),
                            ...
                            child: Column(
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(labelText: '출샹년도'),
                                  validator: FormBuilderValidators.compose([
                                    FormBuilderValidators.required(),
                                ...
                                Container(
                                  ...
                                  Row(
                                    children: [
                                      buildGenderButton('기타'),
                                      SizedBox(width: 10),
                                      buildGenderButton('비공개'),
                                    ],
                                  ),
                                ],
                                                  ),
